 ...
 * @param {Object} data
 */
dudeGraph.Block.buildBlock = function (cgGraph, data) {
...
dudeGraph.Block.prototype.clone = function (cgGraph) {
    if (this._blockType !== "Block") {
        throw new pandora.Exception("Method `clone` must be overridden by `" + this._blockType + "`");
    }
...
dudeGraph.Condition.buildBlock = function (cgGraph, data) {
    return new dudeGraph.Condition(cgGraph, _.merge(data, {
        "cgInputs": [
            {
                "cgName": "in",
                "cgType": "Stream"
...
dudeGraph.Delegate.buildBlock = function (cgGraph, data) {
    return new dudeGraph.Delegate(cgGraph, _.merge(data, {
        "cgOutputs": [
            {
                "cgName": "out",
                "cgType": "Stream"
...
dudeGraph.Each.buildBlock = function (cgGraph, data) {
    return new dudeGraph.Each(cgGraph, _.merge(data, {
        "cgInputs": [
            {
                "cgName": "in",
                "cgType": "Stream"
...
dudeGraph.Function.buildBlock = function (cgGraph, data) {
    return new dudeGraph.Function(cgGraph, _.merge(data, {
...
dudeGraph.Instruction.buildBlock = function (cgGraph, data) {
    return new dudeGraph.Instruction(cgGraph, _.merge(data, {
        "cgInputs": [{
            "cgName": "in",
            "cgType": "Stream"
        }],
...
dudeGraph.Value.rendererBlockUpdater = function (renderer) {
    ...
    dudeGraph.Value.rendererPointUpdater.call(renderer, d3Block.select(".cg-points").selectAll(".cg-output, .cg-input"));
};
...
dudeGraph.GraphSaver.prototype._savePoints = function (points) {
    var result = [];
...
dudeGraph.GraphSaver.prototype._savePoint = function (point) {
    return {
...
dudeGraph.GraphSaver.prototype._saveConnection = function (connection) {
    return {
