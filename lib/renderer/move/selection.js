 ...
 */
dudeGraph.Renderer.prototype.addSelection = function (renderNodes) {
    var renderer = this;
 ...
 */
dudeGraph.Renderer.prototype.removeSelection = function (renderNodes) {
...
dudeGraph.Renderer.prototype.clearSelection = function () {
    this.removeSelection(this._selectedRenderNodes);
};