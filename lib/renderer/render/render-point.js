    ...
    pointGroup
        .call(d3.behavior.drag()
            ...
            .on("dragstart", function () {
                ...
                cursorPoint = new cg.Renderer.Point(point, renderer._getSvgPosition(d3.event.sourceEvent.clientX, d3.event.sourceEvent.clientY));
            ...
            .on("dragend", function () {
                ...
                if (newPoint !== null && connection.replacePoint(cursorPoint, newPoint)) {
                ...
                renderer._removeConnections(_getCursorPointConnections());
            })
        )
        .each(function(point) {
            d3.select(this)
