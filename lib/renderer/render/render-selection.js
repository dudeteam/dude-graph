    ...
    this._svg.call(d3.behavior.drag()
            ...
            .on('drag', function () {
                if (renderer._selectionRectangle) {
                    if (origin === null) {
                        origin = renderer._zoomedSvgPosition(d3.event.x, d3.event.y, true);
                    ...
                    var position = renderer._zoomedSvgPosition(d3.event.x, d3.event.y, true);
            ...
            .on('dragend', function () {
                ...
                if (d3.event.sourceEvent.shiftKey) {
                    renderer._getEntitiesInArea(renderer._selectionBox).each(function () {
