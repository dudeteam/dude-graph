...
/**
 * Watches events on the graph
 * @private
 */
dudeGraph.Renderer.prototype._watchGraph = function () {
    var renderer = this;
    ...
    this._graph.on("point-disconnect", function (point, connection) {
        var renderConnection = renderer.renderConnectionByConnection(connection);
        if (renderConnection !== null) {
            renderer.removeRenderConnection(renderConnection, true);
        }
    });
};
