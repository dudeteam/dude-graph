 ...
 * @constructor
 * @param {SVGElement} svg The svg DOM Element on which the svg will be attached
 * @param {Object} data
 * @param {Object} data.config - The renderer configuration
 * @param {Array<Object>} data.blocks - The rendererBlocks
 * @param {Array<Object>} data.groups - The rendererGroups
 * @param {dudeGraph.Graph} cgGraph - The graph that will be rendered
 */
dudeGraph.Renderer = function (svg, cgGraph, data) {
     ...
     * @private
     */
    this._config = _.merge(data.config || {}, {
        "zoom": {
            "min": 0.25,
            "max": 5,
            "transitionSpeed": 300
 ...
 * @param {Function?} blockClass.rendererBlockCreator
 * @param {Function?} blockClass.rendererBlockUpdater
 * @param {Function?} blockClass.pointPositionGetter
 */
