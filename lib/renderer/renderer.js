cg.Renderer = (function () {
    ...
    /** Stub for clamp **/
    // TODO: Move in Pandora.
    (function(){if(!pandora.clamp){pandora.clamp=function(x,a,b){return Math.min(Math.max(x,a),b)}}})();

    /**
     * Zoom to best fit all entites in the renderer.
     */
    Renderer.prototype.zoomToFit = function () {
        ...
        this._zoom.translate(translate).scale(scale).event(this._svg);
    };
