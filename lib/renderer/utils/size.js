 ...
 * @returns {Array<Number>}
 */
dudeGraph.Renderer.prototype.centerWorld = function () {
    var svgRect = this._d3Svg.node().getBoundingClientRect();
    var svgWidth = svgRect.right - svgRect.left;
    var svgHeight = svgRect.bottom - svgRect.top;
    return this.screenToWorld([svgWidth / 2, svgHeight / 2]);
};