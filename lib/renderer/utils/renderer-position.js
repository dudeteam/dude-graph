...
cg.Renderer.prototype._getSelectionZoomedSVGBox = function (d3selection) {
    ...
    d3selection.each(function () {
        ...
        var zoomedPosition = renderer._getZoomedSVGPosition(elementBBox.x, elementBBox.y, true);
        var zoomedSize = renderer._getZoomedSVGPosition(elementBBox.x + elementBBox.width, elementBBox.y + elementBBox.height, true);
