cg.Renderer = function () {
        ...
        paper.mouseup(function () {
            ...
            if (this._cursorConnection !== null) {
                this._rootElement.selectAll(this._cursorPoint.isInput ? ".input" : ".output").forEach(function (pointGroup) {
                    ...
                    var box = this._getAbsolutePointPosition(point);
                    box.width = pointGroup.getBBox().width;
                    box.height = pointGroup.getBBox().height;
    ...
    Renderer.prototype._getAbsoluteNodePosition = function (action) {
        var x = 0;
        var y = 0;
        while (action) {
            x += action.position.x;
    ...
    Renderer.prototype._getAbsolutePointPosition = function (point) {
        ...
        var actionPosition = this._getAbsoluteNodePosition(point.action);
        return new cg.Vec2(
