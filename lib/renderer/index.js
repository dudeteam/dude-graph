cg.Renderer = function () {
    ...
    function Renderer(paper) {
        ...
        //cg.pickerVec3(this._rootElement, {x: 1, y: 32, z: -5}, new cg.Vec2(170, 332));
        //cg.pickerVec2(this._rootElement, {x: 0.234, y: 0.4}, new cg.Vec2(140, 352));
        //var a = cg.pickerString(this._rootElement, "a bigger text", new cg.Vec2(155, 372));
        //a.click(function () {
        //    window.prompt("name");
        //});
        //cg.pickerBoolean(this._rootElement, true, new cg.Vec2(170, 395));
