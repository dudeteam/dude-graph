    ...
    function Renderer(paper) {
        ...
        paper.mousemove(function (e) {
            ...
            if (this._cursorConnection != null) {
                this._cursorPoint.position.x = e.x;
                this._cursorPoint.position.y = e.y;
        ...
        paper.mouseup(function (e) {
            ...
            if (this._cursorConnection !== null) {
                ...
                this._cursorConnection = null;
                this._cursorPoint = null;
                console.log("TODO: attach to the closest point.");
            }
        }.bind(this));
        ...
        group.drag(
            ...
            function (x, y, e) {
                if (e.altKey) {
                    ...
                    this._cursorPoint = new CursorPoint(new cg.Vec2(x, y), point.type, !point.isInput);
