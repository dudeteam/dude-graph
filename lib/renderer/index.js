cg.Renderer = (function () {
     ...
     * @constructor
     */
    function Renderer(paper, config) {
         ...
         * @type {{type: String, position: cg.Vec2, isInput: Boolean}|null}
         * @private
         */
        ...
        Renderer.prototype.initialize.call(this, config);
    }

    /**
     * Initialize Renderer.
     */
    Renderer.prototype.initialize = function (config) {
        this._paper.background = new cg.BackgroundGrid(this._paper, config["background-grid"]);
