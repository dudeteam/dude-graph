cg.Renderer = (function () {
    ...
    function Renderer(paper, style) {
        ...
        Renderer.prototype.initialize.call(this, style);
    }

    /**
     * Initialize Renderer.
     */
    Renderer.prototype.initialize = function (style) {
        this._paper.background = new cg.BackgroundGrid(this._paper, style["background-grid"]);
