 ...
 * @param {String} [customPanel=null]
 * @class
 * @extends {dudeGraph.RenderNode}
 */
dudeGraph.RenderBlock = function (renderer, rendererBlockId, block, customPanel) {
    ...
    /**
     * The id of the custom panel used to edit this block. If null, the default edit block panel will be used.
     * @type {String}
     * @protected
     */
    this._customPanel = customPanel || null;
    Object.defineProperty(this, "customPanel", {
        get: function () {
