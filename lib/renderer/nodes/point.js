...
dudeGraph.RenderPoint.prototype.update = function () {
    ...
    var pointColor = renderPoint._renderer.config.typeColors[renderPoint.point.cgValueType] ||
        renderPoint._renderer.config.defaultColor;
    this._d3Circle
        .attr({
    ...
    renderPoint._d3Circle.call(d3.behavior.drag()
        ...
        .on("dragend", function () {
            ...
            if (renderPointFound && renderPoint !== renderPointFound) {
                ...
                renderPoint._renderer.emit("drop-connection", renderConnection, d3.mouse(this));
            }
...
dudeGraph.RenderPoint.prototype.empty = function () {
    return _.isEmpty(this.renderConnections) && this._point._cgValue === null;
};