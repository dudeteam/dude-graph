...
cg.Renderer.prototype._renderPoint = function (point, element) {
    ...
    var circleSize = 3;
    var pointCircle = pointGroup.circle(0, 0, circleSize);
    pointCircle.addClass("type-" + point.type);
    var tx = circleSize * 2 + this._config.point["padding"];
    var pointText = pointGroup.text(point.isInput ? tx : -tx, circleSize, point.name);
