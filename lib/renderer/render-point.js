...
cg.Renderer.prototype._renderPoint = function (point, element) {
    ...
    //console.log(pointText.getBBox().width, pointText.node.getBoundingClientRect().width, point.name);
    pointGroup.data("width", pointCircle.data("size") * 2 + pointText.getBBox().width + this._config.point.padding);
    return pointGroup;
};
