...
dudeGraph.Renderer.prototype.zoomToFit = function () {
    this._zoomToBoundingBox(this.renderNodesRect(this._renderBlocks.concat(this._renderGroups)));
};
...
dudeGraph.Renderer.prototype.zoomToSelection = function () {
    if (!_.isEmpty(this._selectedRenderNodes)) {
        this._zoomToBoundingBox(this.renderNodesRect(this._selectedRenderNodes));
    }
};
