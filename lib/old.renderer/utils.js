    ...
    interact(nodeGroup.node)
        ...
        .draggable({
            ...
            onend: function () {
                ...
                var done = false;
                for (var groupIndex = allGroups.items.length - 1; !done && groupIndex >= 0; --groupIndex) {
                    ((function (dropGroupElement) {
                    ...
                    }.bind(this))(allGroups.items[groupIndex]));
                }
            }.bind(this)
        });
    /**
...
cg.Renderer.prototype.checkbox = function (element, value, style) {
    style = style || {
        "size": 10,
        "borderRadius": 0
    };
    ...
    group.rect(0, 0, style.size, style.size, style.borderRadius);
    ...
    //group.mousedown(pandora.preventCallback);
