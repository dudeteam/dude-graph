...
dudeGraph.defaultBlocks = [
    ...
    {"block": "Format", "type": dudeGraph.Format},
...
dudeGraph.defaultPoints = [
    ...
    {"point": "Resource", "type": dudeGraph.Resource},
...
dudeGraph.defaultRenderBlocks = [
    ...
    {"renderBlock": "Format", "type": dudeGraph.RenderBlock},
...
dudeGraph.defaultRenderPoints = [
    {"renderPoint": "Choice", "type": dudeGraph.RenderPoint},
    {"renderPoint": "Resource", "type": dudeGraph.RenderPoint},
    {"renderPoint": "Stream", "type": dudeGraph.RenderPoint}
];