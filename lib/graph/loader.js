 ...
 */
dudeGraph.GraphLoader = function (cgGraph, data) {
 ...
 * @extends {pandora.EventEmitter}
 */
dudeGraph.GraphLoader.prototype = _.create(pandora.EventEmitter.prototype, {
    "constructor": dudeGraph.GraphLoader
});
 ...
 */
dudeGraph.GraphLoader.prototype.addPointType = function (pointType, pointClass) {
 ...
 */
dudeGraph.GraphLoader.prototype.addBlockType = function (blockType, blockClass) {
 ...
 */
dudeGraph.GraphLoader.prototype.load = function () {
 ...
 */
dudeGraph.GraphLoader.prototype.loadPoints = function (cgBlock, cgBlockData) {
    var self = this;
 ...
 * @param cgBlockData
 */
dudeGraph.GraphLoader.prototype.loadBlock = function (cgBlockData) {
 ...
 * @private
 */
dudeGraph.GraphLoader.prototype._loadBlocks = function (cgGraph, cgBlocksData) {
 ...
 * @private
 */
dudeGraph.GraphLoader.prototype._loadConnections = function (cgGraph, cgConnectionsData) {
