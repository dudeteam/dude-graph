...
dudeGraph.Block = function (blockData) {
    ...
    Object.defineProperty(this, "blockGraph", {
        set: function (blockGraph) {
            if (this._blockGraph !== null && this._blockGraph !== blockGraph) {
 ...
 */
dudeGraph.Block.prototype.added = function () {};
/**
 ...
 */
dudeGraph.Block.prototype.removed = function () {};
 ...
 */
dudeGraph.Block.prototype.acceptConnect = function (blockPoint, otherPoint) {
    if (blockPoint.pointBlock !== this) {
        throw new Error("`" + this.blockFancyName + "` has no `" + blockPoint.pointName + "`");
    }
    return otherPoint === otherPoint;
};
/**
 * Called when a point of this block is connected
 * @param {dudeGraph.Point} point
 * @param {dudeGraph.Point} otherPoint
 */
dudeGraph.Block.prototype.pointConnected = function (point, otherPoint) {};
/**
...
/**
 * Called when a point of this block is disconnected
 * @param {dudeGraph.Point} point
 * @param {dudeGraph.Point} otherPoint
 */
dudeGraph.Block.prototype.pointDisconnected = function (point, otherPoint) {};
...
dudeGraph.Block.prototype.updateTemplate = function (templateName, valueType, ignoreEmit) {
    ...
    if (this._blockGraph.graphValueTypeByName(valueType) === null) {
 ...
 * @param {String} templateName
 * @returns {dudeGraph.Graph.templateTypedef|null}
 */
dudeGraph.Block.prototype.templateByName = function (templateName) {
    if (this._blockGraph === null) {
        throw new Error("`" + this.blockFancyName + "` cannot manipulate templates when not bound to a graph");
    }
    ...
    try {
        if (point.pointTemplate === null) {
            ...
            if (template === null) {
                ...
                throw new Error("`" + this.blockFancyName + "` has no template `" + point.pointTemplate + "`");
            }
...
/**
 * @typedef {Object} dudeGraph.Graph.templateTypedef
 ...
 * @property {Object<String, dudeGraph.Graph.templateTypedef>} [blockTemplates={}]
 */