dudeGraph.ExpressionLexer = function () {
    this._expression = '';
    this._length = 0;
    this._index = 0;
    this._marker = 0;
...
dudeGraph.ExpressionLexer.prototype.peekChar = function () {
    return this._expression[this._index] || '\0';
};
...
dudeGraph.ExpressionLexer.prototype.next = function () {
    ...
    throw new SyntaxError('Unknown token from character ' + this.peekChar());
};
