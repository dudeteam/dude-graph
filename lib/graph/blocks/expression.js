...
dudeGraph.Expression.prototype.pointValueChanged = function (cgPoint, cgValue, oldCgValue) {
    if (cgPoint.cgName === "format") {
        ...
        if (this.inputByName("boolean") === null && cgPoint.cgValue.indexOf("%b") !== -1) {
            this.addPoint(new dudeGraph.Point(this, {"cgName": "boolean", "cgValueType": "Boolean"}, false, null));
        }
        if (this.inputByName("number") !== null && cgPoint.cgValue.indexOf("%d") === -1) {
            this.removePoint(this.inputByName("number"));
        }
        if (this.inputByName("string") !== null && cgPoint.cgValue.indexOf("%s") === -1) {
            this.removePoint(this.inputByName("string"));
        }
        if (this.inputByName("boolean") !== null && cgPoint.cgValue.indexOf("%b") === -1) {
            this.removePoint(this.inputByName("boolean"));
        }
    }
};