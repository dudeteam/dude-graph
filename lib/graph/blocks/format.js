 ...
 */
dudeGraph.Format = function (cgGraph, data) {
 ...
 * @override
 */
dudeGraph.Format.prototype.validate = function () {
    if (!(this.inputByName("format") instanceof dudeGraph.Point) || this.inputByName("format").cgValueType !== "String") {
        throw new Error("Format `" + this.cgId + "` must have an input `format` of type `Point` of cgValueType `String`");
    }
};
 ...
 */
dudeGraph.Format.prototype.pointValueChanged = function (cgPoint, cgValue, oldCgValue) {
    var expression = this;
