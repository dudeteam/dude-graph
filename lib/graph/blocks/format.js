...
dudeGraph.Format.prototype.validatePoints = function () {
    if (!(this.inputByName(this._formatPointName) instanceof dudeGraph.Point) || this.inputByName(this._formatPointName).pointValueType !== "String") {
        throw new Error("Format `" + this.blockId + "` must have an input `" + this._formatPointName + "` of type `Point` of pointValueType `String`");
    }
 ...
 * @private
 */
dudeGraph.Format.prototype._validateFormat = function () {
    var format = this;
