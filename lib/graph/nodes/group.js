cg.Group = (function () {
     ...
     * @constructor
     */
    var Group = pandora.class_("Group", cg.Entity, function (_id, name, position, size) {
        cg.Entity.call(this, _id, this.constructor.typename, name, position);

        /**
         * Group can change its name.
         */
        Object.defineProperty(this, "name", {
            set: function (name) { return this._name = name; }.bind(this)
        });
