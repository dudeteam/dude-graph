cg.Group = (function () {
     ...
     * @constructor
     */
    var Group = pandora.class_("Group", cg.Node, function (_id, name, position, size) {
        cg.Node.call(this, _id, this.constructor.typename, name, position);
        ...
        Object.defineProperty(this, "box", {
            get: function () { return new pandora.Box2(this._position, this._size); }.bind(this)
        });
    });
