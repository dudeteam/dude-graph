...
dudeGraph.GraphLoader.prototype.loadBlock = function (graph, blockData) {
    ...
    _.forEach(blockData.blockOutputs, function (outputPointData) {
        loader.loadPoint(block, true, outputPointData);
    });
    _.forEach(blockData.blockInputs, function (inputPointData) {
        loader.loadPoint(block, false, inputPointData);
    });
