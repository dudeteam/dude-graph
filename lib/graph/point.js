...
dudeGraph.Point = function (pointOutput, pointData) {
     ...
     * @type {dudeGraph.Graph.graphTypeNameTypedef|null}
     * @protected
     */
    ...
    /**
     * Whether this point value type can be converted or must be exactly the same
     * @type {Boolean}
     * @private
     */
    this._pointCanConvert = true;
    Object.defineProperty(this, "pointCanConvert", {
        get: function () {
            return this._pointCanConvert;
        }.bind(this)
    });
...
dudeGraph.Point.prototype.initialize = function (pointData) {
    ...
    this._pointCanConvert = _.isUndefined(pointData.pointCanConvert) ? true : pointData.pointCanConvert;
...
dudeGraph.Point.prototype.changeValueType = function (valueType, ignoreEmit) {
    ...
    if (this._pointBlock.blockGraph.graphTypeByName(valueType) === null) {
 ...
 * @property {Boolean} [pointCanConvert=true]
