...
dudeGraph.Point.prototype.acceptConnect = function (point) {
    ...
    if (this.hasPolicy(dudeGraph.PointPolicy.SINGLE_CONNECTION)) {
        return this.emptyConnection();
    }

    if (this.hasPolicy(dudeGraph.PointPolicy.MULTIPLE_CONNECTIONS)) {
        return true;
    }
...
dudeGraph.PointPolicy = {
    ...
    "has": function (policy, checkPolicy) {
        // TODO: check if checkPolicy is a valid policy
