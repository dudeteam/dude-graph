 ...
 * @param {Boolean} ignoreEmit
 */
dudeGraph.Point.prototype.changeValue = function (value, ignoreEmit) {
    var oldValue = this._pointValue;
    if (value !== null) {
        var assignValue = this._pointBlock.blockGraph.convert(this._pointValueType, value);
        if (assignValue === null) {
    ...
    if (!ignoreEmit) {
        this._pointBlock.blockGraph.emit("value-change", this._pointValue, oldValue);
    }
};
