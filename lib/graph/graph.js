...
dudeGraph.Graph.prototype.convertConnection = function (outputPoint, inputPoint) {
    ...
    if (typeof outputPoint.hasPolicy !== "undefined" && !outputPoint.hasPolicy(dudeGraph.PointPolicy.SINGLE_CONNECTION, dudeGraph.PointPolicy.MULTIPLE_CONNECTIONS)) {
        this.errno(new Error("`" + outputPoint.pointFancyName + "` cannot have connections"));
        return false;
    }
    if (typeof inputPoint.hasPolicy !== "undefined" && !inputPoint.hasPolicy(dudeGraph.PointPolicy.SINGLE_CONNECTION, dudeGraph.PointPolicy.MULTIPLE_CONNECTIONS)) {
