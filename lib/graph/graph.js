...
/**
 * Creates a connection between cgOutputPoint and cgInputPoint
...
dudeGraph.Graph.prototype.connectPoints = function (cgOutputPoint, cgInputPoint) {
    ...
    if (cgInputPoint.cgTemplate !== null) {
        cgInputPoint.cgBlock.updateTemplate(cgInputPoint, cgOutputPoint.cgValueType);
    }
