...
dudeGraph.Graph = function () {
     ...
     * @type {Object<dudeGraph.Graph.graphValueTypeTypedef, dudeGraph.Graph.graphValueTypeDataTypedef>}
     * @private
     */
 ...
 * @param {dudeGraph.Graph.graphValueTypeDataTypedef} graphType
 */
dudeGraph.Graph.prototype.addGraphValueType = function (graphType) {
    if (this.graphValueTypeByName(graphType.typeName) !== null) {
        throw new Error("`" + this.graphFancyName + "` cannot redefine value type`" + graphType.typeName + "`");
    }
    this._graphValueTypes[graphType.typeName] = graphType;
};
 ...
 * @param {dudeGraph.Graph.graphValueTypeTypedef} typeName
 * @returns {dudeGraph.Graph.graphValueTypeDataTypedef|null}
 */
...
dudeGraph.Graph.prototype.convertValue = function (valueType, value) {
    ...
    var graphType = this.graphValueTypeByName(valueType);
    if (graphType === null) {
...
dudeGraph.Graph.prototype.convertConnection = function (outputPoint, inputPoint) {
    var graphType = this.graphValueTypeByName(inputPoint.pointValueType);
    if (graphType === null) {
    ...
    return outputPoint.pointValueType === inputPoint.pointValueType ||
        ...
        _.includes(graphType.typeCompatibles, outputPoint.pointValueType));
};
...
/**
 * @typedef {Object} dudeGraph.Graph.graphValueTypeDataTypedef
