...
dudeGraph.Graph.prototype.convertConnection = function (outputPoint, inputPoint) {
    ...
    var outputCanConvert = _.isUndefined(outputPoint.pointCanConvert) ? true : outputPoint.pointCanConvert;
    var inputCanConvert = _.isUndefined(inputPoint.pointCanConvert) ? true : inputPoint.pointCanConvert;
