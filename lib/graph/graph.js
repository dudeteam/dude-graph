 ...
 * @returns {Boolean}
 */
dudeGraph.Graph.prototype.hasGraphType = function (typeName) {
    return !_.isUndefined(this._graphTypes[typeName]);
};
...
dudeGraph.Graph.prototype.convertValue = function (valueType, value) {
    ...
    if (_.isUndefined(typeInfo.typeConvert)) {
        // TODO: throw message
        throw this._graphTypes;
    }
    return typeInfo.typeConvert(value);
};
/**
