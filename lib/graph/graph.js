...
dudeGraph.Graph.prototype.convertConnection = function (outputPoint, inputPoint) {
    ...
    var outputCanConvert = dudeGraph.PointPolicy.has(outputPoint.pointPolicy, dudeGraph.PointPolicy.CONVERSION);
    var inputCanConvert = dudeGraph.PointPolicy.has(inputPoint.pointPolicy, dudeGraph.PointPolicy.CONVERSION);
    outputCanConvert = typeof outputPoint.pointPolicy === "undefined" ? true : outputCanConvert;
    inputCanConvert = typeof inputPoint.pointPolicy === "undefined" ? true : inputCanConvert;
    if (!outputCanConvert || !inputCanConvert) {
        return false;
    }
    return _.includes(graphInputType.typeCompatibles, outputPoint.pointValueType);
};
...
dudeGraph.Graph.prototype.queryModels = function (point) {
    var graph = this;
    var eligibleModels = [];
    if (!point.emptyValue() || (point.hasPolicy(dudeGraph.PointPolicy.SINGLE_CONNECTION) && !point.emptyConnection())) {
