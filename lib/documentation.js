...
cg.Block = {"cgId": ""};
cg.Point = {"cgName": "", "cgValueType": "", "cgValue": {}, cgConnections: [], cgMaxConnections: 0, isOutput: true};
cg.Connection = {"cgOutputPoint": cg.Point, "cgInputPoint": cg.Point};
...
cg.RendererPoint = {"type": "point", "index": 0, "isOutput": true, "rendererBlock": cg.RendererBlock, "cgPoint": cg.Point};
cg.RendererConnection = {"cgConnection": cg.Connection, "outputRendererPoint": cg.RendererPoint, "inputRendererPoint": cg.RendererPoint};
