cg.JSONSaver = (function () {
    ...
    JSONSaver.prototype.save = function (node) {
        return pandora.polymorphicMethod(this, "save", node);
    };
    ...
    JSONSaver.prototype._saveConnection = function (connection) {
        return {
            "from": {"block": connection.outputPoint.action._id, "point": connection.outputPoint.name},
            "to": {"block": connection.inputPoint.action._id, "point": connection.inputPoint.name}
        };
    };
