cg.JSONLoader = (function () {
    ...
    JSONLoader.prototype.load = function (graph, data) {
        pandora.forEach(data, function (obj, name) {
            ...
            if (loader) {
                ...
                throw new cg.GraphError("Missing loader for " + name + ".");
            }
        }.bind(this));
    };
    ...
    JSONLoader.prototype._loadNodeBlock = function (blockData, graph, parent) {
        var block = new cg.Block(blockData._id, graph.getModel(blockData.name), new cg.Vec2(blockData.position), blockData.value);
