...
cg.Graph = (function () {
    ...
    /**
     * Returns whether this type is allowed for a transput
     * @param type
     * @returns {boolean}
     */
    Graph.prototype.isTypeAllowed = function (type) {
        if (type === undefined || type === null) {
            throw new cg.GraphError("undefined or null is not an acceptable transput value type");
        }
...
cg.Block = (function() {
     ...
     */
    Block.prototype._addTransput = function (transputs, isInput) {
        var self = this;
        ...
        pandora.forEach(transputs, function (transput) {
            ...
            self.emit(pandora.formatString("{0}-created", transputName));
            Object.defineProperty(self, transputName, {
                ...
                set: function (newValue) {
                    ...
                    self.emit(pandora.formatString("{0}-updated", transputName), oldValue, newValue);
                }
            });
        });
    };
    ...
    Block.prototype.addOutputs = function (outputs) {
        this._addTransput(outputs, false);
    };
