...
cg.Graph = (function () {
    ...
    Graph.prototype.addBlock = function (block) {
        ...
        if (blockId === null || blockId === undefined) {
            throw cg.GraphError("Graph::addBlock() block id is null");
        }
        if (this._blocksIds[blockId]) {
            throw cg.GraphError("Graph::addBlock() block with id {0} already exists", blockId);
        }
     ...
     * @returns {boolean}
     */
    Graph.prototype.allowedType = function (type) {
...
cg.Block = (function() {
    ...
    Block.prototype.addInputs = function (inputs) {
        ...
        pandora.forEach(inputs, function (input) {
            ...
            if (!block._cgGraph.allowedType(inputValue)) {
